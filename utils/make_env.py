...
def make_env(scenario_name, benchmark=False, discrete_action=False, use_handcraft_policy=False):
    '''
    ...
    # create world
    world = scenario.make_world(use_handcraft_policy=use_handcraft_policy)
