...
def plot_array(stats_summary1, stats_summary2=None):
    ...
    if stats_summary2 is not None:
        assert stats_summary2.shape[0] == 10, 'dimension is not 10!'
    save_dir_spread = [
        './figs/c_reward.png',
        './figs/room_explored.png',
        './figs/dummy_agents.png',
        './figs/max_belief.png',
        './figs/min_belief.png']
    title_str = [
        'cumulative reward',
        '# of cells explored',
        '# of dummy agents found',
        'max red belief',
        'min red belief']
    legend_position = [
        'upper center',
...
if __name__ == '__main__':
    ...
    if flag_handcraft_policy_data:
        handcraft_policy_data = np.genfromtxt(
            "./text/handcraft.txt", dtype='str')
